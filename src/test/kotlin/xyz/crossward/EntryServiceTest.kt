...
class EntryServiceTest {
    ...
    fun `get puzzle date when date is mon-fri`() {
        val mon5pm = ZonedDateTime.parse("2021-06-28T17:00:00.000000-04:00[US/Eastern]")
        val tus5pm = ZonedDateTime.parse("2021-06-29T17:00:00.000000-04:00[US/Eastern]")
        val wed5pm = ZonedDateTime.parse("2021-06-30T17:00:00.000000-04:00[US/Eastern]")
        val thu5pm = ZonedDateTime.parse("2021-07-01T17:00:00.000000-04:00[US/Eastern]")
        val fri5pm = ZonedDateTime.parse("2021-07-02T17:00:00.000000-04:00[US/Eastern]")
        ...
        val thu11pm = ZonedDateTime.parse("2021-07-01T23:00:00.000000-04:00[US/Eastern]")
        val fri11pm = ZonedDateTime.parse("2021-07-02T23:00:00.000000-04:00[US/Eastern]")
    ...
    fun `get puzzle date when date is sat-sun`() {
        val sat5pm = ZonedDateTime.parse("2021-07-03T17:00:00.000000-04:00[US/Eastern]")
        val sun5pm = ZonedDateTime.parse("2021-07-04T17:00:00.000000-04:00[US/Eastern]")
        ...
        val sat7pm = ZonedDateTime.parse("2021-07-03T19:00:00.000000-04:00[US/Eastern]")
        val sun7pm = ZonedDateTime.parse("2021-07-04T19:00:00.000000-04:00[US/Eastern]")
